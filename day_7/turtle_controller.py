...
def call_set_pen_service(r, g, b, width, off):
    try:
        ...
        # rospy.loginfo(response) #print the response
...
if __name__ == '__main__':
    ...
    rospy.wait_for_service("/turtle1/set_pen") #rosservice list
    call_set_pen_service(255, 0, 0, 3, 0)
    pub = rospy.Publisher("/turtle1/cmd_vel", Twist, queue_size =10) #rosnode list
